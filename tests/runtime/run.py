...
elsewhere = ()
math = ("padstick_abs_i32", "padstick_clamp_i32", "padstick_offset", "padstick_isqrt",
        "padstick_scale_distance", "padstick_apply_axis")
fixtures = (
    ("math", "input_processor_padstick.c", math, ()),
    ("driver", "input_processor_padstick.c", (
        "padstick_reset_contact",
        "padstick_seed_fixed_origin",
        "padstick_repeat_ready",
        "padstick_schedule_repeat",
        "padstick_note_unsignaled_contact_frame",
        "padstick_repeat_work_handler",
        "padstick_suppress_event",
        "padstick_handle_touch",
        "padstick_handle_btn0",
        "padstick_handle_abs_axis",
        "padstick_handle_event",
        "padstick_init",
        "#define PADSTICK_RESYNC",
        "padstick_layer_listener",
    ), math),
)
